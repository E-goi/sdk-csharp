...
namespace org.egoi.client.api.Api
{
    ...
    public interface IPingApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Ping> PingAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Ping>> PingAsyncWithHttpInfo ();
    ...
    public partial class PingApi : IPingApi
    {
        ...
        /// <exception cref="org.egoi.client.api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Ping</returns>
        public async System.Threading.Tasks.Task<Ping> PingAsync ()
        {
             ApiResponse<Ping> localVarResponse = await PingAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="org.egoi.client.api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Ping)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Ping>> PingAsyncWithHttpInfo ()
        {
