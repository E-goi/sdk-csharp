...
namespace org.egoi.client.api.Api
{
    ...
    /// </summary>
    public interface IEcommerceActivityApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class EcommerceActivityApi : IEcommerceActivityApi
    {
        private org.egoi.client.api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="EcommerceActivityApi"/> class.
        /// </summary>
        /// <returns></returns>
        public EcommerceActivityApi(String basePath)
        {
        ...
        /// <returns></returns>
        public EcommerceActivityApi(org.egoi.client.api.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< AcceptedResponse > ImportOrdersBulkWithHttpInfo (int? listId, List<ImportOrdersBulkBulkRequest> importOrdersBulkBulkRequest)
        {
            ...
            if (listId == null)
                throw new ApiException(400, "Missing required parameter 'listId' when calling EcommerceActivityApi->ImportOrdersBulk");
            // verify the required parameter 'importOrdersBulkBulkRequest' is set
            if (importOrdersBulkBulkRequest == null)
                throw new ApiException(400, "Missing required parameter 'importOrdersBulkBulkRequest' when calling EcommerceActivityApi->ImportOrdersBulk");
