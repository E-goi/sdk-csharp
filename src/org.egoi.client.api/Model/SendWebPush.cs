...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendWebPush :  IEquatable<SendWebPush>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendWebPush" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendWebPush() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendWebPush" /> class.
        /// </summary>
        ...
        public SendWebPush(int siteId = default(int), OSegmentsWithoutContactActionSend segments = default(OSegmentsWithoutContactActionSend), List<int> notify = default(List<int>))
        {
            // to ensure "siteId" is required (not null)
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for SendWebPush and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for SendWebPush and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SendWebPush);
        }

        /// <summary>
        /// Returns true if SendWebPush instances are equal
        /// </summary>
        /// <param name="input">Instance of SendWebPush to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendWebPush input)
        {
            if (input == null)
                return false;
