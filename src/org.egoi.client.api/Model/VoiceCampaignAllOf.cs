...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoiceCampaignAllOf :  IEquatable<VoiceCampaignAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VoiceCampaignAllOf);
        }

        /// <summary>
        /// Returns true if VoiceCampaignAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VoiceCampaignAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoiceCampaignAllOf input)
        {
            if (input == null)
                return false;
