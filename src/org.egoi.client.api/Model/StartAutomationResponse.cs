...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StartAutomationResponse :  IEquatable<StartAutomationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartAutomationResponse" /> class.
        /// </summary>
        /// <param name="success">Array of contacts where the automation was successfully started.</param>
        /// <param name="error">Array of contacts where the automation was not successfully started.</param>
        public StartAutomationResponse(List<string> success = default(List<string>), List<string> error = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Array of contacts where the automation was successfully started</value>
        ...
        /// </summary>
        /// <value>Array of contacts where the automation was not successfully started</value>
        ...
        {
            return this.Equals(input as StartAutomationResponse);
        }

        /// <summary>
        /// Returns true if StartAutomationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StartAutomationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartAutomationResponse input)
        {
            if (input == null)
                return false;
