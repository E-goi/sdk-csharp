...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutomationPostAllOf :  IEquatable<AutomationPostAllOf>, IValidatableObject
    {
        /// <summary>
        /// Automation status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationPostAllOf" /> class.
        /// </summary>
        ...
        public AutomationPostAllOf(string title = default(string), int listId = default(int), StatusEnum? status = default(StatusEnum?), bool allowMultipleContacts = true, int contactLimit = default(int))
        {
            this.Title = title;
            this.ListId = listId;
            this.Status = status;
        ...
        {
            return this.Equals(input as AutomationPostAllOf);
        }

        /// <summary>
        /// Returns true if AutomationPostAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationPostAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationPostAllOf input)
        {
            if (input == null)
                return false;
