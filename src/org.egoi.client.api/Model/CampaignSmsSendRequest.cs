...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignSmsSendRequest :  IEquatable<CampaignSmsSendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmsSendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignSmsSendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmsSendRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignSmsSendRequest {\n");
        ...
        {
            return this.Equals(input as CampaignSmsSendRequest);
        }

        /// <summary>
        /// Returns true if CampaignSmsSendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignSmsSendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSmsSendRequest input)
        {
            if (input == null)
                return false;
