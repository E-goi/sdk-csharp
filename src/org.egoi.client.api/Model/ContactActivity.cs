...
namespace org.egoi.client.api.Model
{
    ...
    public partial class ContactActivity :  IEquatable<ContactActivity>, IValidatableObject
    {
        ...
        public ContactActivity(ContactActivityClickAllOfActionData actionData = default(ContactActivityClickAllOfActionData), DateTime date = default(DateTime), ActionNameEnum? actionName = default(ActionNameEnum?))
        {
