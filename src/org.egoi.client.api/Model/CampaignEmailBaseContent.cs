...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailBaseContent :  IEquatable<CampaignEmailBaseContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailBaseContent" /> class.
        /// </summary>
        /// <param name="plainText">Plain text for the campaign.</param>
        /// <param name="snippet">Snippet text for the campaign.</param>
        public CampaignEmailBaseContent(string plainText = default(string), string snippet = default(string))
        {
        ...
        {
            return this.Equals(input as CampaignEmailBaseContent);
        }

        /// <summary>
        /// Returns true if CampaignEmailBaseContent instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailBaseContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailBaseContent input)
        {
            if (input == null)
                return false;
