...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactStats :  IEquatable<ContactStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactStats" /> class.
        /// </summary>
        ...
        public ContactStats(ContactStatsEmailStats emailStats = default(ContactStatsEmailStats), ContactStatsSmsStats smsStats = default(ContactStatsSmsStats), ContactStatsPushStats pushStats = default(ContactStatsPushStats), ContactStatsWebpushStats webpushStats = default(ContactStatsWebpushStats), ContactStatsVoiceStats voiceStats = default(ContactStatsVoiceStats), ContactStatsTrafficStats trafficStats = default(ContactStatsTrafficStats))
        {
        ...
        {
            return this.Equals(input as ContactStats);
        }

        /// <summary>
        /// Returns true if ContactStats instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactStats input)
        {
            if (input == null)
                return false;
