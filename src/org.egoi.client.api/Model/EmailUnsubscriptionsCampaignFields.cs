...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailUnsubscriptionsCampaignFields :  IEquatable<EmailUnsubscriptionsCampaignFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailUnsubscriptionsCampaignFields" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailUnsubscriptionsCampaignFields() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailUnsubscriptionsCampaignFields" /> class.
        /// </summary>
        ...
        public EmailUnsubscriptionsCampaignFields(bool internalName = default(bool), bool campaignHash = default(bool), bool sendDate = default(bool), bool group = default(bool), bool channel = default(bool), bool type = default(bool), bool sender = default(bool))
        {
            // to ensure "internalName" is required (not null)
            if (internalName == null)
            {
                throw new InvalidDataException("internalName is a required property for EmailUnsubscriptionsCampaignFields and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignHash is a required property for EmailUnsubscriptionsCampaignFields and cannot be null");
            }
            else
            {
            ...
            if (sender == null)
            {
                throw new InvalidDataException("sender is a required property for EmailUnsubscriptionsCampaignFields and cannot be null");
            }
            else
            {
                this.Sender = sender;
        ...
        {
            return this.Equals(input as EmailUnsubscriptionsCampaignFields);
        }

        /// <summary>
        /// Returns true if EmailUnsubscriptionsCampaignFields instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailUnsubscriptionsCampaignFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailUnsubscriptionsCampaignFields input)
        {
            if (input == null)
                return false;
