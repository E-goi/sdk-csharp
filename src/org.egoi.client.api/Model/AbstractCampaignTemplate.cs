...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractCampaignTemplate :  IEquatable<AbstractCampaignTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractCampaignTemplate" /> class.
        /// </summary>
        /// <param name="internalName">Campaign internal name.</param>
        public AbstractCampaignTemplate(string internalName = default(string))
        {
        ...
        {
            return this.Equals(input as AbstractCampaignTemplate);
        }

        /// <summary>
        /// Returns true if AbstractCampaignTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractCampaignTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractCampaignTemplate input)
        {
            if (input == null)
                return false;
