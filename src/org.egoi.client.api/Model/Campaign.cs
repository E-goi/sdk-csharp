...
namespace org.egoi.client.api.Model
{
    ...
    public partial class Campaign :  IEquatable<Campaign>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Total number of processed messages</value>
        [DataMember(Name="processed_messages", EmitDefaultValue=false)]
        public int ProcessedMessages { get; set; }

        /// <summary>
        /// The automation id of the campaign
        /// </summary>
        /// <value>The automation id of the campaign</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProcessedMessages: ").Append(ProcessedMessages).Append("\n");
        ...
        public bool Equals(Campaign input)
        {
            ...
            return 
                ...
                (
                    this.ProcessedMessages == input.ProcessedMessages ||
                    (this.ProcessedMessages != null &&
                    this.ProcessedMessages.Equals(input.ProcessedMessages))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProcessedMessages != null)
                    hashCode = hashCode * 59 + this.ProcessedMessages.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ProcessedMessages (int) minimum
            if(this.ProcessedMessages < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProcessedMessages, must be a value greater than or equal to 0.", new [] { "ProcessedMessages" });
            }
