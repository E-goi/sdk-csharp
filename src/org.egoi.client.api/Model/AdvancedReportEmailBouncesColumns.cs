...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportEmailBouncesColumns :  IEquatable<AdvancedReportEmailBouncesColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailBouncesColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportEmailBouncesColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailBouncesColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportEmailBouncesColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), EmailBouncesListStatsFields listStatsFields = default(EmailBouncesListStatsFields), EmailBouncesCampaignFields campaignFields = default(EmailBouncesCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportEmailBouncesColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportEmailBouncesColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportEmailBouncesColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportEmailBouncesColumns and cannot be null");
            }
            else
            {
        ...
        public EmailBouncesListStatsFields ListStatsFields { get; set; }

        /// <summary>
        /// Gets or Sets CampaignFields
        /// </summary>
        [DataMember(Name="campaign_fields", EmitDefaultValue=true)]
        public EmailBouncesCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportEmailBouncesColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportEmailBouncesColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportEmailBouncesColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportEmailBouncesColumns input)
        {
            if (input == null)
                return false;
