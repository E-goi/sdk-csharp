...
namespace org.egoi.client.api.Model
{
    ...
    public partial class Automation :  IEquatable<Automation>, IValidatableObject
    {
        ...
        public Automation(string title = default(string), int listId = default(int), StatusEnum? status = default(StatusEnum?), bool allowMultipleContacts = true, int contactLimit = default(int))
        {
            this.Title = title;
            this.ListId = listId;
            this.Status = status;
