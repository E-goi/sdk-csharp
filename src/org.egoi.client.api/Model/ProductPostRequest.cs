...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductPostRequest :  IEquatable<ProductPostRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductPostRequest" /> class.
        /// </summary>
        ...
        /// <param name="productIdentifier">The ID of the product in your store (required).</param>
        ...
        public ProductPostRequest(List<string> categories = default(List<string>), List<string> relatedProducts = default(List<string>), List<ProductCustomAttributes> customAttributes = default(List<ProductCustomAttributes>), string productIdentifier = default(string), string name = default(string), string description = default(string), string sku = default(string), string upc = default(string), string ean = default(string), string gtin = default(string), string mpn = default(string), string link = default(string), string imageLink = default(string), double price = 0D, double salePrice = 0D, string brand = default(string))
        {
            ...
            {
                throw new InvalidDataException("productIdentifier is a required property for ProductPostRequest and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductPostRequest and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        [DataMember(Name="product_identifier", EmitDefaultValue=true)]
