...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneCampaignTemplate : AbstractCampaignTemplate,  IEquatable<PhoneCampaignTemplate>, IValidatableObject
    {
        /// <summary>
        /// Message type
        /// </summary>
        ...
        public PhoneCampaignTemplate(string message = default(string), string sender = default(string), MessageTypeEnum? messageType = default(MessageTypeEnum?), string internalName = default(string)) : base(templateId, templateHash, internalName, created, updated)
        {
