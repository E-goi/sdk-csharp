...
namespace org.egoi.client.api.Model
{
    ...
    public partial class PhoneCampaignTemplate :  IEquatable<PhoneCampaignTemplate>, IValidatableObject
    {
        ...
        public PhoneCampaignTemplate(string message = default(string), string sender = default(string), MessageTypeEnum? messageType = default(MessageTypeEnum?), string internalName = default(string))
        {
