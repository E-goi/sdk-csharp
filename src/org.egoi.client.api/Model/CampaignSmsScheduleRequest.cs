...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignSmsScheduleRequest :  IEquatable<CampaignSmsScheduleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmsScheduleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignSmsScheduleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmsScheduleRequest" /> class.
        /// </summary>
        ...
        public CampaignSmsScheduleRequest(DateTime scheduleDate = default(DateTime), int listId = default(int), string destinationField = default(string), SmsSegmentsActionSend segments = default(SmsSegmentsActionSend), List<int> notify = default(List<int>))
        {
            // to ensure "listId" is required (not null)
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for CampaignSmsScheduleRequest and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            {
                throw new InvalidDataException("destinationField is a required property for CampaignSmsScheduleRequest and cannot be null");
            }
            else
            {
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for CampaignSmsScheduleRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CampaignSmsScheduleRequest);
        }

        /// <summary>
        /// Returns true if CampaignSmsScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignSmsScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSmsScheduleRequest input)
        {
            if (input == null)
                return false;
