...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactActivityClick :  IEquatable<ContactActivityClick>, IValidatableObject
    {
        /// <summary>
        /// Action name
        /// </summary>
        ...
        public enum ActionNameEnum
        {
            ...
            /// <summary>
            /// Enum Smartsmsclick for value: smart_sms_click
            /// </summary>
            [EnumMember(Value = "smart_sms_click")]
            Smartsmsclick = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactActivityClick" /> class.
        /// </summary>
        /// <param name="actionData">actionData.</param>
        /// <param name="date">The date and time.</param>
        /// <param name="actionName">Action name.</param>
        public ContactActivityClick(ContactActivityClickAllOfActionData actionData = default(ContactActivityClickAllOfActionData), DateTime date = default(DateTime), ActionNameEnum? actionName = default(ActionNameEnum?))
        {
        ...
        {
            return this.Equals(input as ContactActivityClick);
        }

        /// <summary>
        /// Returns true if ContactActivityClick instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactActivityClick to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactActivityClick input)
        {
            if (input == null)
                return false;
