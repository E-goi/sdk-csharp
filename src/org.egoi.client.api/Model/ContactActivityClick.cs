...
namespace org.egoi.client.api.Model
{
    ...
    public partial class ContactActivityClick :  IEquatable<ContactActivityClick>, IValidatableObject
    {
        ...
        public ContactActivityClick(DateTime date = default(DateTime), ActionNameEnum? actionName = default(ActionNameEnum?), ContactActivityClickAllOfActionData actionData = default(ContactActivityClickAllOfActionData))
        {
            this.Date = date;
