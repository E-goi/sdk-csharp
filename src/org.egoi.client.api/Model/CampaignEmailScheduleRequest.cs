...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailScheduleRequest :  IEquatable<CampaignEmailScheduleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailScheduleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignEmailScheduleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailScheduleRequest" /> class.
        /// </summary>
        ...
        public CampaignEmailScheduleRequest(DateTime scheduleDate = default(DateTime), int listId = default(int), EmailSendSegment segments = default(EmailSendSegment), List<int> notify = default(List<int>), string destinationField = default(string), bool uniqueContactsOnly = false)
        {
            // to ensure "listId" is required (not null)
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for CampaignEmailScheduleRequest and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for CampaignEmailScheduleRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CampaignEmailScheduleRequest);
        }

        /// <summary>
        /// Returns true if CampaignEmailScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailScheduleRequest input)
        {
            if (input == null)
                return false;
