...
{
    /// <summary>
    /// EmailReportByDateDate
    /// </summary>
    [DataContract]
    public partial class EmailReportByDateDate :  IEquatable<EmailReportByDateDate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailReportByDateDate" /> class.
        /// </summary>
        ...
        public EmailReportByDateDate(DateTime date = default(DateTime), int sends = default(int), int opens = default(int), int clicks = default(int), int hardBounces = default(int), int softBounces = default(int), int complaints = default(int), int unsubscriptions = default(int))
        {
            this.Date = date;
            this.Sends = sends;
            this.Opens = opens;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailReportByDateDate {\n");
        ...
        {
            return this.Equals(input as EmailReportByDateDate);
        }

        /// <summary>
        /// Returns true if EmailReportByDateDate instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailReportByDateDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailReportByDateDate input)
        {
            if (input == null)
                return false;
