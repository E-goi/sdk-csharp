...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SingleOrderObject :  IEquatable<SingleOrderObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleOrderObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SingleOrderObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleOrderObject" /> class.
        /// </summary>
        ...
        public SingleOrderObject(string orderId = default(string), decimal revenue = default(decimal), string storeUrl = default(string), List<ImportOrdersBulkBulkRequestItems> items = default(List<ImportOrdersBulkBulkRequestItems>))
        {
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for SingleOrderObject and cannot be null");
            }
            else
            {
            ...
            if (revenue == null)
            {
                throw new InvalidDataException("revenue is a required property for SingleOrderObject and cannot be null");
            }
            else
            {
            ...
            if (storeUrl == null)
            {
                throw new InvalidDataException("storeUrl is a required property for SingleOrderObject and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for SingleOrderObject and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        {
            return this.Equals(input as SingleOrderObject);
        }

        /// <summary>
        /// Returns true if SingleOrderObject instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleOrderObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleOrderObject input)
        {
            if (input == null)
                return false;
