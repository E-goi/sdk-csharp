...
namespace org.egoi.client.api.Model
{
    ...
    public partial class Segment :  IEquatable<Segment>, IValidatableObject
    {
        ...
        public Segment(string segmentId = default(string), string name = default(string), SavedSegmentAllOfSegmentFilter segmentFilter = default(SavedSegmentAllOfSegmentFilter))
        {
