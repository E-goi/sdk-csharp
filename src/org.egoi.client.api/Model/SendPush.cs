...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendPush :  IEquatable<SendPush>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendPush" /> class.
        /// </summary>
        ...
        public SendPush(string appId = default(string), OSegmentsWithoutContactActionSend segments = default(OSegmentsWithoutContactActionSend), List<int> notify = default(List<int>))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for SendPush and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for SendPush and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SendPush);
        }

        /// <summary>
        /// Returns true if SendPush instances are equal
        /// </summary>
        /// <param name="input">Instance of SendPush to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendPush input)
        {
            if (input == null)
                return false;
