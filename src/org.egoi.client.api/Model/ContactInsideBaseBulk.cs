...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactInsideBaseBulk :  IEquatable<ContactInsideBaseBulk>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactInsideBaseBulk" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactInsideBaseBulk);
        }

        /// <summary>
        /// Returns true if ContactInsideBaseBulk instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactInsideBaseBulk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactInsideBaseBulk input)
        {
            if (input == null)
                return false;
