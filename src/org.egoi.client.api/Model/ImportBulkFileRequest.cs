...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportBulkFileRequest :  IEquatable<ImportBulkFileRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportBulkFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportBulkFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportBulkFileRequest" /> class.
        /// </summary>
        ...
        /// <param name="file">File to import (required).</param>
        public ImportBulkFileRequest(ModeEnum mode = default(ModeEnum), string compareField = default(string), List<ContactBulk> contacts = default(List<ContactBulk>), bool forceEmpty = false, List<int> notify = default(List<int>), string callbackUrl = default(string), ContactBulkFile file = default(ContactBulkFile))
        {
            // to ensure "mode" is required (not null)
            if (mode == null)
            {
                throw new InvalidDataException("mode is a required property for ImportBulkFileRequest and cannot be null");
            }
            else
            {
                this.Mode = mode;
            ...
            {
                throw new InvalidDataException("compareField is a required property for ImportBulkFileRequest and cannot be null");
            }
            else
            {
            ...
            if (contacts == null)
            {
                throw new InvalidDataException("contacts is a required property for ImportBulkFileRequest and cannot be null");
            }
            else
            {
            ...
            if (file == null)
            {
                throw new InvalidDataException("file is a required property for ImportBulkFileRequest and cannot be null");
            }
            else
            {
                this.File = file;
        ...
        public ContactBulkFile File { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportBulkFileRequest {\n");
        ...
        {
            return this.Equals(input as ImportBulkFileRequest);
        }

        /// <summary>
        /// Returns true if ImportBulkFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportBulkFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportBulkFileRequest input)
        {
            if (input == null)
                return false;
