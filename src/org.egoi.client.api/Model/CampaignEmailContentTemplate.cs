...
namespace org.egoi.client.api.Model
{
    ...
    public partial class CampaignEmailContentTemplate :  IEquatable<CampaignEmailContentTemplate>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CampaignEmailContentTemplate);
        }

        /// <summary>
        /// Returns true if CampaignEmailContentTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailContentTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailContentTemplate input)
        {
            if (input == null)
                return false;
