...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportSendsColumns :  IEquatable<AdvancedReportSendsColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSendsColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportSendsColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSendsColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportSendsColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), SendsCampaignFields campaignFields = default(SendsCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportSendsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportSendsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportSendsColumns and cannot be null");
            }
            else
            {
        ...
        public SendsCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportSendsColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportSendsColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportSendsColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportSendsColumns input)
        {
            if (input == null)
                return false;
