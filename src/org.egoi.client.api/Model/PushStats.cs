...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushStats :  IEquatable<PushStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushStats" /> class.
        /// </summary>
        ...
        /// <param name="received">Total number of received messages.</param>
        /// <param name="bounces">Total number of bounces.</param>
        /// <param name="error">Total number of error messages.</param>
        public PushStats(int sends = default(int), int opens = default(int), int delivered = default(int), int received = default(int), int bounces = default(int), int error = default(int))
        {
            this.Sends = sends;
            this.Opens = opens;
        ...
        /// </summary>
        /// <value>Total number of received messages</value>
        ...
        /// </summary>
        /// <value>Total number of error messages</value>
        ...
        {
            return this.Equals(input as PushStats);
        }

        /// <summary>
        /// Returns true if PushStats instances are equal
        /// </summary>
        /// <param name="input">Instance of PushStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushStats input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Received (int) minimum
            if(this.Received < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Received, must be a value greater than or equal to 0.", new [] { "Received" });
            }
