...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutomationPost :  IEquatable<AutomationPost>, IValidatableObject
    {
        /// <summary>
        /// Automation status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationPost" /> class.
        /// </summary>
        ...
        public AutomationPost(string title = default(string), int listId = default(int), StatusEnum? status = default(StatusEnum?), bool allowMultipleContacts = true, int contactLimit = default(int))
        {
            this.Title = title;
            this.ListId = listId;
            this.Status = status;
        ...
        {
            return this.Equals(input as AutomationPost);
        }

        /// <summary>
        /// Returns true if AutomationPost instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationPost input)
        {
            if (input == null)
                return false;
