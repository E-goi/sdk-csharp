...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignSmartSmsSendRequest :  IEquatable<CampaignSmartSmsSendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmartSmsSendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignSmartSmsSendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmartSmsSendRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignSmartSmsSendRequest {\n");
        ...
        {
            return this.Equals(input as CampaignSmartSmsSendRequest);
        }

        /// <summary>
        /// Returns true if CampaignSmartSmsSendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignSmartSmsSendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSmartSmsSendRequest input)
        {
            if (input == null)
                return false;
