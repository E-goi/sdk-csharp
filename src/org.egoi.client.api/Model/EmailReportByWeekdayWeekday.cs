...
{
    /// <summary>
    /// EmailReportByWeekdayWeekday
    /// </summary>
    [DataContract]
    public partial class EmailReportByWeekdayWeekday :  IEquatable<EmailReportByWeekdayWeekday>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailReportByWeekdayWeekday" /> class.
        /// </summary>
        /// <param name="weekday">Numeric representation of the day of the week (0 for sunday).</param>
        ...
        public EmailReportByWeekdayWeekday(string weekday = default(string), int sends = default(int), int opens = default(int), int clicks = default(int), int hardBounces = default(int), int softBounces = default(int), int complaints = default(int), int unsubscriptions = default(int))
        {
        ...
        /// </summary>
        /// <value>Numeric representation of the day of the week (0 for sunday)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailReportByWeekdayWeekday {\n");
        ...
        {
            return this.Equals(input as EmailReportByWeekdayWeekday);
        }

        /// <summary>
        /// Returns true if EmailReportByWeekdayWeekday instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailReportByWeekdayWeekday to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailReportByWeekdayWeekday input)
        {
            if (input == null)
                return false;
