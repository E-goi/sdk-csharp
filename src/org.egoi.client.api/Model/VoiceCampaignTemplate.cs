...
namespace org.egoi.client.api.Model
{
    ...
    public partial class VoiceCampaignTemplate :  IEquatable<VoiceCampaignTemplate>, IValidatableObject
    {
        ...
        public VoiceCampaignTemplate(string file = default(string), List<Object> options = default(List<Object>), string message = default(string), string sender = default(string), MessageTypeEnum? messageType = default(MessageTypeEnum?), string internalName = default(string))
        {
            this.File = file;
