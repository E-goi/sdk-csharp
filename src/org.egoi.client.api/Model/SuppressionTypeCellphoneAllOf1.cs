...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuppressionTypeCellphoneAllOf1 :  IEquatable<SuppressionTypeCellphoneAllOf1>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SuppressionTypeCellphoneAllOf1);
        }

        /// <summary>
        /// Returns true if SuppressionTypeCellphoneAllOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SuppressionTypeCellphoneAllOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuppressionTypeCellphoneAllOf1 input)
        {
            if (input == null)
                return false;
