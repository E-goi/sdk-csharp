...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneReport :  IEquatable<PhoneReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneReport" /> class.
        /// </summary>
        /// <param name="networks">Stats of the campaign for each network.</param>
        /// <param name="overall">overall.</param>
        public PhoneReport(List<PhoneReportAllOfNetworks> networks = default(List<PhoneReportAllOfNetworks>), OverallOverall overall = default(OverallOverall))
        {
        ...
        /// </summary>
        /// <value>Stats of the campaign for each network</value>
        [DataMember(Name="networks", EmitDefaultValue=false)]
        public List<PhoneReportAllOfNetworks> Networks { get; set; }
        ...
        {
            return this.Equals(input as PhoneReport);
        }

        /// <summary>
        /// Returns true if PhoneReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneReport input)
        {
            if (input == null)
                return false;
