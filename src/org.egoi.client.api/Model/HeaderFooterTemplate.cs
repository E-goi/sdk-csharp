...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HeaderFooterTemplate :  IEquatable<HeaderFooterTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HeaderFooterTemplate" /> class.
        /// </summary>
        /// <param name="internalName">Internal name of the template.</param>
        public HeaderFooterTemplate(string internalName = default(string))
        {
        ...
        /// </summary>
        /// <value>Internal name of the template</value>
        ...
        /// </summary>
        /// <value>True if this is a template created by some user</value>
        ...
        {
            return this.Equals(input as HeaderFooterTemplate);
        }

        /// <summary>
        /// Returns true if HeaderFooterTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of HeaderFooterTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HeaderFooterTemplate input)
        {
            if (input == null)
                return false;
