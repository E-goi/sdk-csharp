...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneSender :  IEquatable<PhoneSender>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneSender" /> class.
        /// </summary>
        ...
        public PhoneSender(string phone = default(string), byte[] file = default(byte[]))
        {
            // to ensure "phone" is required (not null)
            if (phone == null)
            {
                throw new InvalidDataException("phone is a required property for PhoneSender and cannot be null");
            }
            else
            {
                this.Phone = phone;
            ...
            if (file == null)
            {
                throw new InvalidDataException("file is a required property for PhoneSender and cannot be null");
            }
            else
            {
                this.File = file;
        ...
        {
            return this.Equals(input as PhoneSender);
        }

        /// <summary>
        /// Returns true if PhoneSender instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneSender to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneSender input)
        {
            if (input == null)
                return false;
