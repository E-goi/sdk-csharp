...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportEmailClicksByContactColumns :  IEquatable<AdvancedReportEmailClicksByContactColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailClicksByContactColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportEmailClicksByContactColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailClicksByContactColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportEmailClicksByContactColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), EmailClicksByContactListStatsFields listStatsFields = default(EmailClicksByContactListStatsFields), EmailClicksByContactCampaignFields campaignFields = default(EmailClicksByContactCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportEmailClicksByContactColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportEmailClicksByContactColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportEmailClicksByContactColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportEmailClicksByContactColumns and cannot be null");
            }
            else
            {
        ...
        public EmailClicksByContactListStatsFields ListStatsFields { get; set; }

        /// <summary>
        /// Gets or Sets CampaignFields
        /// </summary>
        [DataMember(Name="campaign_fields", EmitDefaultValue=true)]
        public EmailClicksByContactCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportEmailClicksByContactColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportEmailClicksByContactColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportEmailClicksByContactColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportEmailClicksByContactColumns input)
        {
            if (input == null)
                return false;
