...
namespace org.egoi.client.api.Model
{
    ...
    public partial class ComplexList :  IEquatable<ComplexList>, IValidatableObject
    {
        ...
        public ComplexList(Language defaultLanguage = default(Language), List<string> availableLanguages = default(List<string>), ComplexListAllOfStats stats = default(ComplexListAllOfStats), string internalName = default(string), string publicName = default(string))
        {
