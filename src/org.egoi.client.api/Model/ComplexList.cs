...
namespace org.egoi.client.api.Model
{
    ...
    public partial class ComplexList :  IEquatable<ComplexList>, IValidatableObject
    {
        ...
        public ComplexList(Language language = default(Language), ComplexListAllOfStats stats = default(ComplexListAllOfStats), string internalName = default(string), string publicName = default(string))
        {
