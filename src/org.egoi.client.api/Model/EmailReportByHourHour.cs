...
{
    /// <summary>
    /// EmailReportByHourHour
    /// </summary>
    [DataContract]
    public partial class EmailReportByHourHour :  IEquatable<EmailReportByHourHour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailReportByHourHour" /> class.
        /// </summary>
        /// <param name="hour">24-hour format of an hour with leading zeros.</param>
        ...
        public EmailReportByHourHour(string hour = default(string), int sends = default(int), int opens = default(int), int clicks = default(int), int hardBounces = default(int), int softBounces = default(int), int complaints = default(int), int unsubscriptions = default(int))
        {
            this.Hour = hour;
            this.Sends = sends;
            this.Opens = opens;
        ...
        /// </summary>
        /// <value>24-hour format of an hour with leading zeros</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailReportByHourHour {\n");
        ...
        {
            return this.Equals(input as EmailReportByHourHour);
        }

        /// <summary>
        /// Returns true if EmailReportByHourHour instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailReportByHourHour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailReportByHourHour input)
        {
            if (input == null)
                return false;
