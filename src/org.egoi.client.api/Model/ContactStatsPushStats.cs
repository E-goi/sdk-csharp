...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactStatsPushStats :  IEquatable<ContactStatsPushStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactStatsPushStats" /> class.
        /// </summary>
        ...
        public ContactStatsPushStats(int sent = default(int), int delivered = default(int), int notDelivered = default(int), int views = default(int), int clicks = default(int), DateTime? lastViewDate = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as ContactStatsPushStats);
        }

        /// <summary>
        /// Returns true if ContactStatsPushStats instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactStatsPushStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactStatsPushStats input)
        {
            if (input == null)
                return false;
