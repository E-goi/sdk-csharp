...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractSendVoiceAllOf1 :  IEquatable<AbstractSendVoiceAllOf1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractSendVoiceAllOf1" /> class.
        /// </summary>
        /// <param name="uniqueContactsOnly">True to send the campaign only to unique contacts (default to false).</param>
        public AbstractSendVoiceAllOf1(bool uniqueContactsOnly = false)
        {
        ...
        {
            return this.Equals(input as AbstractSendVoiceAllOf1);
        }

        /// <summary>
        /// Returns true if AbstractSendVoiceAllOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractSendVoiceAllOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractSendVoiceAllOf1 input)
        {
            if (input == null)
                return false;
