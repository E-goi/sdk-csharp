...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsEventsCampaignFields :  IEquatable<SmsEventsCampaignFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsEventsCampaignFields" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SmsEventsCampaignFields() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsEventsCampaignFields" /> class.
        /// </summary>
        ...
        public SmsEventsCampaignFields(bool internalName = default(bool), bool campaignHash = default(bool), bool sendDate = default(bool), bool group = default(bool), bool channel = default(bool), bool type = default(bool), bool sender = default(bool))
        {
            // to ensure "internalName" is required (not null)
            if (internalName == null)
            {
                throw new InvalidDataException("internalName is a required property for SmsEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignHash is a required property for SmsEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            if (sendDate == null)
            {
                throw new InvalidDataException("sendDate is a required property for SmsEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            if (group == null)
            {
                throw new InvalidDataException("group is a required property for SmsEventsCampaignFields and cannot be null");
            }
            else
            {
                this.Group = group;
            ...
            if (sender == null)
            {
                throw new InvalidDataException("sender is a required property for SmsEventsCampaignFields and cannot be null");
            }
            else
            {
                this.Sender = sender;
        ...
        {
            return this.Equals(input as SmsEventsCampaignFields);
        }

        /// <summary>
        /// Returns true if SmsEventsCampaignFields instances are equal
        /// </summary>
        /// <param name="input">Instance of SmsEventsCampaignFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmsEventsCampaignFields input)
        {
            if (input == null)
                return false;
