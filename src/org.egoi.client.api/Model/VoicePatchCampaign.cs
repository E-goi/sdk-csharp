...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicePatchCampaign :  IEquatable<VoicePatchCampaign>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicePatchCampaign" /> class.
        /// </summary>
        /// <param name="internalName">Voice campaign internal name.</param>
        /// <param name="groupId">groupId.</param>
        /// <param name="message">message.</param>
        /// <param name="senderId">senderId.</param>
        public VoicePatchCampaign(string internalName = default(string), int groupId = default(int), ContentVoicePatch message = default(ContentVoicePatch), int senderId = default(int))
        {
        ...
        {
            return this.Equals(input as VoicePatchCampaign);
        }

        /// <summary>
        /// Returns true if VoicePatchCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of VoicePatchCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicePatchCampaign input)
        {
            if (input == null)
                return false;
