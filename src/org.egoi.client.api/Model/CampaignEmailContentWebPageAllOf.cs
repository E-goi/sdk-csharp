...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailContentWebPageAllOf :  IEquatable<CampaignEmailContentWebPageAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailContentWebPageAllOf" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="url">Campaign url.</param>
        /// <param name="usePageTitle">True to use page title as the campaign title (default to false).</param>
        public CampaignEmailContentWebPageAllOf(TypeEnum? type = default(TypeEnum?), string url = default(string), bool usePageTitle = false)
        {
            this.Type = type;
            this.Url = url;
        ...
        {
            return this.Equals(input as CampaignEmailContentWebPageAllOf);
        }

        /// <summary>
        /// Returns true if CampaignEmailContentWebPageAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailContentWebPageAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailContentWebPageAllOf input)
        {
            if (input == null)
                return false;
