...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicePatchCampaignAllOf :  IEquatable<VoicePatchCampaignAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicePatchCampaignAllOf" /> class.
        /// </summary>
        /// <param name="internalName">Voice campaign internal name.</param>
        /// <param name="groupId">groupId.</param>
        /// <param name="message">message.</param>
        /// <param name="senderId">senderId.</param>
        public VoicePatchCampaignAllOf(string internalName = default(string), int groupId = default(int), ContentVoicePatch message = default(ContentVoicePatch), int senderId = default(int))
        {
        ...
        public ContentVoicePatch Message { get; set; }
        ...
        {
            return this.Equals(input as VoicePatchCampaignAllOf);
        }

        /// <summary>
        /// Returns true if VoicePatchCampaignAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VoicePatchCampaignAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicePatchCampaignAllOf input)
        {
            if (input == null)
                return false;
