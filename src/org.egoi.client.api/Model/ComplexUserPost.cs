...
namespace org.egoi.client.api.Model
{
    ...
    public partial class ComplexUserPost :  IEquatable<ComplexUserPost>, IValidatableObject
    {
        ...
        public ComplexUserPost(string firstName = default(string), string lastName = default(string), string email = default(string), string phone = default(string), Language language = default(Language), GenderEnum? gender = default(GenderEnum?))
        {
