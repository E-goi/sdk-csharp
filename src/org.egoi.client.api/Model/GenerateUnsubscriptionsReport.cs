...
namespace org.egoi.client.api.Model
{
    ...
    public partial class GenerateUnsubscriptionsReport :  IEquatable<GenerateUnsubscriptionsReport>, IValidatableObject
    {
        ...
        public GenerateUnsubscriptionsReport(string title = default(string), AdvancedReportRange range = default(AdvancedReportRange), int? lists = default(int?), AdvancedReportUnsubscriptionsColumns columns = default(AdvancedReportUnsubscriptionsColumns), AdvancedReportUnsubscriptionsOptions options = default(AdvancedReportUnsubscriptionsOptions), string callbackUrl = default(string))
        {
