...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractCellphoneSender :  IEquatable<AbstractCellphoneSender>, IValidatableObject
    {
        /// <summary>
        /// Sender code type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractCellphoneSender" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AbstractCellphoneSender() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractCellphoneSender" /> class.
        /// </summary>
        /// <param name="type">Sender code type (required).</param>
        public AbstractCellphoneSender(TypeEnum type = default(TypeEnum))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AbstractCellphoneSender and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as AbstractCellphoneSender);
        }

        /// <summary>
        /// Returns true if AbstractCellphoneSender instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractCellphoneSender to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractCellphoneSender input)
        {
            if (input == null)
                return false;
