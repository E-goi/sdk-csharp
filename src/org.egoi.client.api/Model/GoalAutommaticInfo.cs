...
namespace org.egoi.client.api.Model
{
    ...
    public partial class GoalAutommaticInfo :  IEquatable<GoalAutommaticInfo>, IValidatableObject
    {
        ...
        public GoalAutommaticInfo(TypeEnum? type = default(TypeEnum?), RuleEnum? rule = default(RuleEnum?), ConditionEnum? condition = default(ConditionEnum?), string pattern = default(string), ModelBool caseSensitive = default(ModelBool), ModelBool multipleConversion = default(ModelBool))
        {
            this.Type = type;
            this.Rule = rule;
        ...
        public ModelBool CaseSensitive { get; set; }
