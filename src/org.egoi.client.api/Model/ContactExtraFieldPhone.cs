...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactExtraFieldPhone :  IEquatable<ContactExtraFieldPhone>, IValidatableObject
    {
        /// <summary>
        /// Extra field format
        /// </summary>
        ...
        {
            return this.Equals(input as ContactExtraFieldPhone);
        }

        /// <summary>
        /// Returns true if ContactExtraFieldPhone instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactExtraFieldPhone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactExtraFieldPhone input)
        {
            if (input == null)
                return false;
