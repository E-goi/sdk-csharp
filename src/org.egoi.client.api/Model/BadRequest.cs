...
namespace org.egoi.client.api.Model
{
    ...
    public partial class BadRequest :  IEquatable<BadRequest>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum BadRequest for value: Bad Request
            /// </summary>
        ...
        public BadRequest(string type = default(string), TitleEnum? title = default(TitleEnum?), int status = default(int), string detail = default(string))
        {
            this.Type = type;
            this.Title = title;
            this.Status = status;
