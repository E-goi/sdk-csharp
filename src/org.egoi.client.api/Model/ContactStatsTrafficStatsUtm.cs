...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactStatsTrafficStatsUtm :  IEquatable<ContactStatsTrafficStatsUtm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactStatsTrafficStatsUtm" /> class.
        /// </summary>
        /// <param name="utmSource">Utm source value.</param>
        /// <param name="utmMedium">Utm medium value.</param>
        /// <param name="utmCampaign">Utm campaign value.</param>
        /// <param name="utmContent">Utm content value.</param>
        /// <param name="utmTerm">Utm source value.</param>
        public ContactStatsTrafficStatsUtm(string utmSource = default(string), string utmMedium = default(string), string utmCampaign = default(string), string utmContent = default(string), string utmTerm = default(string))
        {
        ...
        /// Utm campaign value
        /// </summary>
        /// <value>Utm campaign value</value>
        ...
        {
            return this.Equals(input as ContactStatsTrafficStatsUtm);
        }

        /// <summary>
        /// Returns true if ContactStatsTrafficStatsUtm instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactStatsTrafficStatsUtm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactStatsTrafficStatsUtm input)
        {
            if (input == null)
                return false;
