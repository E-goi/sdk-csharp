...
namespace org.egoi.client.api.Model
{
    ...
    public partial class CampaignSmartSmsScheduleRequest : SendSmartSms,  IEquatable<CampaignSmartSmsScheduleRequest>, IValidatableObject
    {
        ...
        public CampaignSmartSmsScheduleRequest(DateTime? scheduleDate = default(DateTime?), int? listId = default(int?), string destinationField = default(string), SmartSmsSegmentsActionSend segments = default(SmartSmsSegmentsActionSend), LimitHourActionSendLimitHour limitHour = default(LimitHourActionSendLimitHour), List<int?> notify = default(List<int?>)) : base(segments)
        {
