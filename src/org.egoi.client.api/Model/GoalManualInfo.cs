...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GoalManualInfo :  IEquatable<GoalManualInfo>, IValidatableObject
    {
        /// <summary>
        /// Goal type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoalManualInfo" /> class.
        /// </summary>
        /// <param name="type">Goal type.</param>
        /// <param name="multipleConversion">Goal is multiple conversion.</param>
        public GoalManualInfo(TypeEnum? type = default(TypeEnum?), bool multipleConversion = default(bool))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as GoalManualInfo);
        }

        /// <summary>
        /// Returns true if GoalManualInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GoalManualInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoalManualInfo input)
        {
            if (input == null)
                return false;
