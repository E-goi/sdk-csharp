...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailSendNowRequest :  IEquatable<CampaignEmailSendNowRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailSendNowRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignEmailSendNowRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailSendNowRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CampaignEmailSendNowRequest);
        }

        /// <summary>
        /// Returns true if CampaignEmailSendNowRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailSendNowRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailSendNowRequest input)
        {
            if (input == null)
                return false;
