...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsBouncesListStatsFields :  IEquatable<SmsBouncesListStatsFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsBouncesListStatsFields" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SmsBouncesListStatsFields() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsBouncesListStatsFields" /> class.
        /// </summary>
        ...
        public SmsBouncesListStatsFields(bool deliveryAnswer = default(bool), bool deliveryDate = default(bool))
        {
            // to ensure "deliveryAnswer" is required (not null)
            if (deliveryAnswer == null)
            {
                throw new InvalidDataException("deliveryAnswer is a required property for SmsBouncesListStatsFields and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("deliveryDate is a required property for SmsBouncesListStatsFields and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="delivery_answer", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as SmsBouncesListStatsFields);
        }

        /// <summary>
        /// Returns true if SmsBouncesListStatsFields instances are equal
        /// </summary>
        /// <param name="input">Instance of SmsBouncesListStatsFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmsBouncesListStatsFields input)
        {
            if (input == null)
                return false;
