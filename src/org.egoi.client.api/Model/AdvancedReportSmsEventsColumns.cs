...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportSmsEventsColumns :  IEquatable<AdvancedReportSmsEventsColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSmsEventsColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportSmsEventsColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSmsEventsColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportSmsEventsColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), SmsEventsListStatsFields listStatsFields = default(SmsEventsListStatsFields), SmsEventsCampaignFields campaignFields = default(SmsEventsCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportSmsEventsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportSmsEventsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportSmsEventsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportSmsEventsColumns and cannot be null");
            }
            else
            {
        ...
        public SmsEventsListStatsFields ListStatsFields { get; set; }

        /// <summary>
        /// Gets or Sets CampaignFields
        /// </summary>
        [DataMember(Name="campaign_fields", EmitDefaultValue=true)]
        public SmsEventsCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportSmsEventsColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportSmsEventsColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportSmsEventsColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportSmsEventsColumns input)
        {
            if (input == null)
                return false;
