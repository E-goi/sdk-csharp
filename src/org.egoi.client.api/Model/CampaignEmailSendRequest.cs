...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailSendRequest :  IEquatable<CampaignEmailSendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailSendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignEmailSendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailSendRequest" /> class.
        /// </summary>
        ...
        public CampaignEmailSendRequest(int listId = default(int), EmailSendSegment segments = default(EmailSendSegment), List<int> notify = default(List<int>), string destinationField = default(string), bool uniqueContactsOnly = false, LimitHourActionSendLimitHour limitHour = default(LimitHourActionSendLimitHour), DateTime scheduleDate = default(DateTime))
        {
            ...
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for CampaignEmailSendRequest and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for CampaignEmailSendRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignEmailSendRequest {\n");
        ...
        {
            return this.Equals(input as CampaignEmailSendRequest);
        }

        /// <summary>
        /// Returns true if CampaignEmailSendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailSendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailSendRequest input)
        {
            if (input == null)
                return false;
