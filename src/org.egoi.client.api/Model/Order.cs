...
namespace org.egoi.client.api.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="orderId">Ecommerce order id.</param>
        ...
        public Order(string orderId = default(string), double cartTotal = default(double), string cartId = default(string), Contact contact = default(Contact), List<Product> products = default(List<Product>))
        {
