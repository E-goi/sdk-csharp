...
namespace org.egoi.client.api.Model
{
    ...
    public partial class SavedSegmentAllOf1SegmentFilter :  IEquatable<SavedSegmentAllOf1SegmentFilter>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Boolean operator for all segment conditions</value>
        ...
        public SavedSegmentAllOf1SegmentFilter(List<SavedSegmentAllOf1SegmentFilterSegmentFilterArray> segmentFilterArray = default(List<SavedSegmentAllOf1SegmentFilterSegmentFilterArray>), BooleanOperatorEnum? booleanOperator = BooleanOperatorEnum.And, bool invert = false)
        {
            ...
            {
                this.BooleanOperator = BooleanOperatorEnum.And;
            }
            else
            {
                this.BooleanOperator = booleanOperator;
            }
            // use default value if no "invert" provided
            if (invert == null)
            {
                this.Invert = false;
            }
        ...
        /// </summary>
        /// <value>If true inverts the search result</value>
        [DataMember(Name="invert", EmitDefaultValue=false)]
        ...
        public bool Equals(SavedSegmentAllOf1SegmentFilter input)
        {
            ...
            return 
                (
                    this.SegmentFilterArray == input.SegmentFilterArray ||
                    this.SegmentFilterArray != null &&
                    input.SegmentFilterArray != null &&
                    this.SegmentFilterArray.SequenceEqual(input.SegmentFilterArray)
                ) && 
                (
                    this.BooleanOperator == input.BooleanOperator ||
                    (this.BooleanOperator != null &&
                    this.BooleanOperator.Equals(input.BooleanOperator))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SegmentFilterArray != null)
                    hashCode = hashCode * 59 + this.SegmentFilterArray.GetHashCode();
                if (this.BooleanOperator != null)
                    hashCode = hashCode * 59 + this.BooleanOperator.GetHashCode();
                if (this.Invert != null)
