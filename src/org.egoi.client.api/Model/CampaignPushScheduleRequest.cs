...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignPushScheduleRequest : SendPush,  IEquatable<CampaignPushScheduleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CampaignPushScheduleRequest(DateTime? scheduleDate = default(DateTime?), int? appId = default(int?), OSegmentsWithoutContactActionSend segments = default(OSegmentsWithoutContactActionSend), List<int?> notify = default(List<int?>)) : base(appId)
        {
