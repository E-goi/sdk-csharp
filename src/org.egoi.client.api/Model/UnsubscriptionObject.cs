...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnsubscriptionObject :  IEquatable<UnsubscriptionObject>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsubscriptionObject" /> class.
        /// </summary>
        ...
        public UnsubscriptionObject(UnsubscriptionMethodEnum? unsubscriptionMethod = default(UnsubscriptionMethodEnum?), UnsubscriptionReasonEnum? unsubscriptionReason = default(UnsubscriptionReasonEnum?), string unsubscriptionObservation = default(string))
        {
        ...
        {
            return this.Equals(input as UnsubscriptionObject);
        }

        /// <summary>
        /// Returns true if UnsubscriptionObject instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsubscriptionObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsubscriptionObject input)
        {
            if (input == null)
                return false;
