...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateContactsRequest :  IEquatable<UpdateContactsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected UpdateContactsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateContactsRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateContactsRequest);
        }

        /// <summary>
        /// Returns true if UpdateContactsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateContactsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateContactsRequest input)
        {
            if (input == null)
                return false;
