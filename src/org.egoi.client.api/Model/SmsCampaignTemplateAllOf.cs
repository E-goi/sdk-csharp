...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsCampaignTemplateAllOf :  IEquatable<SmsCampaignTemplateAllOf>, IValidatableObject
    {
        /// <summary>
        /// Message encoding
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsCampaignTemplateAllOf" /> class.
        /// </summary>
        /// <param name="encoding">Message encoding.</param>
        /// <param name="maxMessages">Maximum number of messages.</param>
        public SmsCampaignTemplateAllOf(EncodingEnum? encoding = default(EncodingEnum?), int maxMessages = default(int))
        {
        ...
        {
            return this.Equals(input as SmsCampaignTemplateAllOf);
        }

        /// <summary>
        /// Returns true if SmsCampaignTemplateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SmsCampaignTemplateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmsCampaignTemplateAllOf input)
        {
            if (input == null)
                return false;
