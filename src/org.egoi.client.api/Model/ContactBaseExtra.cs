...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactBaseExtra :  IEquatable<ContactBaseExtra>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactBaseExtra" /> class.
        /// </summary>
        /// <param name="_base">Contact base fields.</param>
        /// <param name="extra">Array of the contact&#39;s extra fields.</param>
        public ContactBaseExtra(ContactInsideBase _base = default(ContactInsideBase), List<ContactExtraFields> extra = default(List<ContactExtraFields>))
        {
            this.Base = _base;
            this.Extra = extra;
        }
        ...
        {
            return this.Equals(input as ContactBaseExtra);
        }

        /// <summary>
        /// Returns true if ContactBaseExtra instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactBaseExtra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactBaseExtra input)
        {
            if (input == null)
                return false;
