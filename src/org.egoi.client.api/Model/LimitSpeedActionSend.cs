...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LimitSpeedActionSend :  IEquatable<LimitSpeedActionSend>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitSpeedActionSend" /> class.
        /// </summary>
        /// <param name="limitSpeed">Speed limit to send the campaign.</param>
        public LimitSpeedActionSend(int limitSpeed = default(int))
        {
        ...
        {
            return this.Equals(input as LimitSpeedActionSend);
        }

        /// <summary>
        /// Returns true if LimitSpeedActionSend instances are equal
        /// </summary>
        /// <param name="input">Instance of LimitSpeedActionSend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LimitSpeedActionSend input)
        {
            if (input == null)
                return false;
