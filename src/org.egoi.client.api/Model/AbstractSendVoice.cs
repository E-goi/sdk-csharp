...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractSendVoice :  IEquatable<AbstractSendVoice>, IValidatableObject
    {
        /// <summary>
        ...
        public AbstractSendVoice(int listId = default(int), DestinationFieldEnum destinationField = default(DestinationFieldEnum), bool uniqueContactsOnly = false, OSegmentsActionSend segments = default(OSegmentsActionSend), List<int> notify = default(List<int>), OLimitContactsActionSend limitContacts = default(OLimitContactsActionSend), LimitHourActionSendLimitHour limitHour = default(LimitHourActionSendLimitHour), int limitSpeed = default(int))
        {
            // to ensure "listId" is required (not null)
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for AbstractSendVoice and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            {
                throw new InvalidDataException("destinationField is a required property for AbstractSendVoice and cannot be null");
            }
            else
            {
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for AbstractSendVoice and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AbstractSendVoice);
        }

        /// <summary>
        /// Returns true if AbstractSendVoice instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractSendVoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractSendVoice input)
        {
            if (input == null)
                return false;
