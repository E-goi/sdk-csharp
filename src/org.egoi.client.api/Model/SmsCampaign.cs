...
namespace org.egoi.client.api.Model
{
    ...
    public partial class SmsCampaign :  IEquatable<SmsCampaign>, IValidatableObject
    {
        ...
        /// <param name="internalName">SMS campaign internal name (required).</param>
        /// <param name="content">content (required).</param>
        /// <param name="senderId">senderId.</param>
        /// <param name="options">options.</param>
        public SmsCampaign(int listId = default(int), string internalName = default(string), CampaignSmsContent content = default(CampaignSmsContent), int senderId = default(int), CampaignSmsOptions options = default(CampaignSmsOptions))
        {
            ...
            {
                throw new InvalidDataException("internalName is a required property for SmsCampaign and cannot be null");
            }
            else
            {
            ...
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for SmsCampaign and cannot be null");
            }
            else
            {
        ...
        public CampaignSmsContent Content { get; set; }
