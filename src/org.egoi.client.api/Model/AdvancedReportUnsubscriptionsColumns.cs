...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportUnsubscriptionsColumns :  IEquatable<AdvancedReportUnsubscriptionsColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportUnsubscriptionsColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportUnsubscriptionsColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportUnsubscriptionsColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportUnsubscriptionsColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), UnsubscriptionsListStatsFields listStatsFields = default(UnsubscriptionsListStatsFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportUnsubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportUnsubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportUnsubscriptionsColumns and cannot be null");
            }
            else
            {
        ...
        public UnsubscriptionsListStatsFields ListStatsFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportUnsubscriptionsColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportUnsubscriptionsColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportUnsubscriptionsColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportUnsubscriptionsColumns input)
        {
            if (input == null)
                return false;
