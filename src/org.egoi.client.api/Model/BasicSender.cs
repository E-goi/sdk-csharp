...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BasicSender :  IEquatable<BasicSender>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicSender" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BasicSender);
        }

        /// <summary>
        /// Returns true if BasicSender instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicSender to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicSender input)
        {
            if (input == null)
                return false;
