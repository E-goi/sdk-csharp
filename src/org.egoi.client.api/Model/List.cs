...
namespace org.egoi.client.api.Model
{
    ...
    public partial class List :  IEquatable<List>, IValidatableObject
    {
        ...
        public List(string internalName = default(string), string publicName = default(string))
        {
            // to ensure "publicName" is required (not null)
            if (publicName == null)
            {
                throw new InvalidDataException("publicName is a required property for List and cannot be null");
            }
            else
            {
