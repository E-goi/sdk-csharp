...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactBaseWithStatusFieldsSchemaBase :  IEquatable<ContactBaseWithStatusFieldsSchemaBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactBaseWithStatusFieldsSchemaBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactBaseWithStatusFieldsSchemaBase);
        }

        /// <summary>
        /// Returns true if ContactBaseWithStatusFieldsSchemaBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactBaseWithStatusFieldsSchemaBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactBaseWithStatusFieldsSchemaBase input)
        {
            if (input == null)
                return false;
