...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignSmsOptions :  IEquatable<CampaignSmsOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines Encoding
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmsOptions" /> class.
        /// </summary>
        /// <param name="encoding">encoding.</param>
        /// <param name="maxMessages">maxMessages.</param>
        public CampaignSmsOptions(EncodingEnum? encoding = default(EncodingEnum?), int maxMessages = default(int))
        {
        ...
        {
            return this.Equals(input as CampaignSmsOptions);
        }

        /// <summary>
        /// Returns true if CampaignSmsOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignSmsOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSmsOptions input)
        {
            if (input == null)
                return false;
