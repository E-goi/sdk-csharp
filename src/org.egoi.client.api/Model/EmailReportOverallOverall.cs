...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailReportOverallOverall :  IEquatable<EmailReportOverallOverall>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailReportOverallOverall" /> class.
        /// </summary>
        /// <param name="sends">Total number of sent messages.</param>
        /// <param name="opens">Total number of open messages.</param>
        /// <param name="uniqueOpens">Total number of unique open messages.</param>
        /// <param name="clicks">Total number of clicks in message.</param>
        /// <param name="uniqueClicks">Total number of unique clicks in message.</param>
        ...
        public EmailReportOverallOverall(int sends = default(int), int opens = default(int), int uniqueOpens = default(int), int clicks = default(int), int uniqueClicks = default(int), int hardBounces = default(int), int softBounces = default(int), int complaints = default(int), int unsubscriptions = default(int))
        {
            this.Sends = sends;
            this.Opens = opens;
        ...
        /// </summary>
        /// <value>Total number of unique open messages</value>
        ...
        /// </summary>
        /// <value>Total number of unique clicks in message</value>
        ...
        {
            return this.Equals(input as EmailReportOverallOverall);
        }

        /// <summary>
        /// Returns true if EmailReportOverallOverall instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailReportOverallOverall to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailReportOverallOverall input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // UniqueOpens (int) minimum
            if(this.UniqueOpens < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UniqueOpens, must be a value greater than or equal to 0.", new [] { "UniqueOpens" });
            }
            ...
            // UniqueClicks (int) minimum
            if(this.UniqueClicks < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UniqueClicks, must be a value greater than or equal to 0.", new [] { "UniqueClicks" });
            }
