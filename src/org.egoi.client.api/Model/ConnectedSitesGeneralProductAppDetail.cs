...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectedSitesGeneralProductAppDetail :  IEquatable<ConnectedSitesGeneralProductAppDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectedSitesGeneralProductAppDetail" /> class.
        /// </summary>
        /// <param name="internalName">Internal Name.</param>
        public ConnectedSitesGeneralProductAppDetail(string internalName = default(string))
        {
        ...
        {
            return this.Equals(input as ConnectedSitesGeneralProductAppDetail);
        }

        /// <summary>
        /// Returns true if ConnectedSitesGeneralProductAppDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectedSitesGeneralProductAppDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectedSitesGeneralProductAppDetail input)
        {
            if (input == null)
                return false;
