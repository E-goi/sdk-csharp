...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactExtraFieldDate :  IEquatable<ContactExtraFieldDate>, IValidatableObject
    {
        /// <summary>
        /// Extra field format
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactExtraFieldDate" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactExtraFieldDate);
        }

        /// <summary>
        /// Returns true if ContactExtraFieldDate instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactExtraFieldDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactExtraFieldDate input)
        {
            if (input == null)
                return false;
