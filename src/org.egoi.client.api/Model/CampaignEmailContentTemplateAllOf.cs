...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailContentTemplateAllOf :  IEquatable<CampaignEmailContentTemplateAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as CampaignEmailContentTemplateAllOf);
        }

        /// <summary>
        /// Returns true if CampaignEmailContentTemplateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailContentTemplateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailContentTemplateAllOf input)
        {
            if (input == null)
                return false;
