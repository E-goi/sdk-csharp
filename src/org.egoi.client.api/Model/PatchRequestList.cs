...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PatchRequestList :  IEquatable<PatchRequestList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchRequestList" /> class.
        /// </summary>
        /// <param name="internalName">Internal name of the list.</param>
        /// <param name="publicName">Public name of the list.</param>
        /// <param name="groupId">groupId.</param>
        public PatchRequestList(string internalName = default(string), string publicName = default(string), int groupId = default(int))
        {
        ...
        {
            return this.Equals(input as PatchRequestList);
        }

        /// <summary>
        /// Returns true if PatchRequestList instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchRequestList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchRequestList input)
        {
            if (input == null)
                return false;
