...
namespace org.egoi.client.api.Model
{
    ...
    public partial class InlineObject :  IEquatable<InlineObject>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject" /> class.
        /// </summary>
        /// <param name="domain">Website&#39;s Domain without protocol (required).</param>
        /// <param name="listId">Website&#39;s List.</param>
        public InlineObject(string domain = default(string), int listId = default(int))
        {
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new InvalidDataException("domain is a required property for InlineObject and cannot be null");
            }
            else
            {
                this.Domain = domain;
        ...
        /// </summary>
        /// <value>Website&#39;s Domain without protocol</value>
