...
namespace org.egoi.client.api.Model
{
    ...
    public partial class UnprocessableEntity :  IEquatable<UnprocessableEntity>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="errors">Information about the input validation.</param>
        /// <param name="type">RFC for status code definitions.</param>
        /// <param name="title">Error title.</param>
        /// <param name="status">Status code.</param>
        /// <param name="detail">Error detail.</param>
        public UnprocessableEntity(Object errors = default(Object), string type = default(string), TitleEnum? title = default(TitleEnum?), int status = default(int), string detail = default(string))
        {
            this.Errors = errors;
            this.Type = type;
            this.Title = title;
        ...
        /// </summary>
        /// <value>Information about the input validation</value>
