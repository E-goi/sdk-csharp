...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendSmartSms :  IEquatable<SendSmartSms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendSmartSms" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendSmartSms() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendSmartSms" /> class.
        /// </summary>
        ...
        public SendSmartSms(int listId = default(int), string destinationField = default(string), SmartSmsSegmentsActionSend segments = default(SmartSmsSegmentsActionSend), LimitHourActionSendLimitHour limitHour = default(LimitHourActionSendLimitHour), List<int> notify = default(List<int>))
        {
            // to ensure "listId" is required (not null)
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for SendSmartSms and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            {
                throw new InvalidDataException("destinationField is a required property for SendSmartSms and cannot be null");
            }
            else
            {
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for SendSmartSms and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SendSmartSms);
        }

        /// <summary>
        /// Returns true if SendSmartSms instances are equal
        /// </summary>
        /// <param name="input">Instance of SendSmartSms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendSmartSms input)
        {
            if (input == null)
                return false;
