...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportBulkFileRequestSchema :  IEquatable<ImportBulkFileRequestSchema>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportBulkFileRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportBulkFileRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportBulkFileRequestSchema" /> class.
        /// </summary>
        ...
        public ImportBulkFileRequestSchema(ModeEnum mode = default(ModeEnum), string compareField = default(string), ContactBulkFile file = default(ContactBulkFile), bool forceEmpty = false, List<int> notify = default(List<int>), string callbackUrl = default(string))
        {
            // to ensure "mode" is required (not null)
            if (mode == null)
            {
                throw new InvalidDataException("mode is a required property for ImportBulkFileRequestSchema and cannot be null");
            }
            else
            {
                this.Mode = mode;
            ...
            {
                throw new InvalidDataException("compareField is a required property for ImportBulkFileRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (file == null)
            {
                throw new InvalidDataException("file is a required property for ImportBulkFileRequestSchema and cannot be null");
            }
            else
            {
                this.File = file;
        ...
        {
            return this.Equals(input as ImportBulkFileRequestSchema);
        }

        /// <summary>
        /// Returns true if ImportBulkFileRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportBulkFileRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportBulkFileRequestSchema input)
        {
            if (input == null)
                return false;
