...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactStatsWebpushStats :  IEquatable<ContactStatsWebpushStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactStatsWebpushStats" /> class.
        /// </summary>
        ...
        public ContactStatsWebpushStats(int sent = default(int), int delivered = default(int), int clicks = default(int), int bounces = default(int), DateTime lastSendDate = default(DateTime), DateTime lastDeliveryDate = default(DateTime), DateTime lastClickDate = default(DateTime), DateTime lastBounceDate = default(DateTime))
        {
            this.Sent = sent;
        ...
        {
            return this.Equals(input as ContactStatsWebpushStats);
        }

        /// <summary>
        /// Returns true if ContactStatsWebpushStats instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactStatsWebpushStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactStatsWebpushStats input)
        {
            if (input == null)
                return false;
