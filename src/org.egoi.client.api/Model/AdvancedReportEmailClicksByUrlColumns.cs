...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportEmailClicksByUrlColumns :  IEquatable<AdvancedReportEmailClicksByUrlColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailClicksByUrlColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportEmailClicksByUrlColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailClicksByUrlColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportEmailClicksByUrlColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), EmailClicksByUrlListStatsFields listStatsFields = default(EmailClicksByUrlListStatsFields), EmailClicksByUrlCampaignFields campaignFields = default(EmailClicksByUrlCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportEmailClicksByUrlColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportEmailClicksByUrlColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportEmailClicksByUrlColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportEmailClicksByUrlColumns and cannot be null");
            }
            else
            {
        ...
        public EmailClicksByUrlListStatsFields ListStatsFields { get; set; }

        /// <summary>
        /// Gets or Sets CampaignFields
        /// </summary>
        [DataMember(Name="campaign_fields", EmitDefaultValue=true)]
        public EmailClicksByUrlCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportEmailClicksByUrlColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportEmailClicksByUrlColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportEmailClicksByUrlColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportEmailClicksByUrlColumns input)
        {
            if (input == null)
                return false;
