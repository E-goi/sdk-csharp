...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushReportAllOf :  IEquatable<PushReportAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushReportAllOf" /> class.
        /// </summary>
        ...
        public PushReportAllOf(List<Object> operatingSystems = default(List<Object>), List<Object> brands = default(List<Object>))
        {
        ...
        {
            return this.Equals(input as PushReportAllOf);
        }

        /// <summary>
        /// Returns true if PushReportAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PushReportAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushReportAllOf input)
        {
            if (input == null)
                return false;
