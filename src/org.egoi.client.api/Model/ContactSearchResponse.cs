...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactSearchResponse :  IEquatable<ContactSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactSearchResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactSearchResponse);
        }

        /// <summary>
        /// Returns true if ContactSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactSearchResponse input)
        {
            if (input == null)
                return false;
