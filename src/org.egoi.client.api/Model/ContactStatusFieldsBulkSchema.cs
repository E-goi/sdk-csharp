...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactStatusFieldsBulkSchema :  IEquatable<ContactStatusFieldsBulkSchema>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactStatusFieldsBulkSchema" /> class.
        /// </summary>
        ...
        public ContactStatusFieldsBulkSchema(EmailStatusEnum? emailStatus = default(EmailStatusEnum?), CellphoneStatusEnum? cellphoneStatus = default(CellphoneStatusEnum?), PhoneStatusEnum? phoneStatus = default(PhoneStatusEnum?))
        {
        ...
        {
            return this.Equals(input as ContactStatusFieldsBulkSchema);
        }

        /// <summary>
        /// Returns true if ContactStatusFieldsBulkSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactStatusFieldsBulkSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactStatusFieldsBulkSchema input)
        {
            if (input == null)
                return false;
