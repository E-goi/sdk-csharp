...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteCampaignsConflict :  IEquatable<DeleteCampaignsConflict>, IValidatableObject
    {
        /// <summary>
        /// Error title
        /// </summary>
        ...
        public CampaignSentLast30DaysErrors Errors { get; set; }
        ...
        {
            return this.Equals(input as DeleteCampaignsConflict);
        }

        /// <summary>
        /// Returns true if DeleteCampaignsConflict instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteCampaignsConflict to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteCampaignsConflict input)
        {
            if (input == null)
                return false;
