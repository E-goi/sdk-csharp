...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetachTagRequest :  IEquatable<DetachTagRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetachTagRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DetachTagRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetachTagRequest" /> class.
        /// </summary>
        /// <param name="tagId">tagId (required).</param>
        /// <param name="contacts">Array of contacts to detach the tag (required).</param>
        /// <param name="segmentId">segmentId (required).</param>
        /// <param name="fieldId">fieldId (required).</param>
        public DetachTagRequest(int tagId = default(int), List<string> contacts = default(List<string>), string segmentId = default(string), string fieldId = default(string))
        {
            // to ensure "tagId" is required (not null)
            if (tagId == null)
            {
                throw new InvalidDataException("tagId is a required property for DetachTagRequest and cannot be null");
            }
            else
            {
                this.TagId = tagId;
            ...
            if (contacts == null)
            {
                throw new InvalidDataException("contacts is a required property for DetachTagRequest and cannot be null");
            }
            else
            {
            ...
            if (segmentId == null)
            {
                throw new InvalidDataException("segmentId is a required property for DetachTagRequest and cannot be null");
            }
            else
            {
            ...
            if (fieldId == null)
            {
                throw new InvalidDataException("fieldId is a required property for DetachTagRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array of contacts to detach the tag</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetachTagRequest {\n");
        ...
        {
            return this.Equals(input as DetachTagRequest);
        }

        /// <summary>
        /// Returns true if DetachTagRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DetachTagRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetachTagRequest input)
        {
            if (input == null)
                return false;
