...
namespace org.egoi.client.api.Model
{
    ...
    public partial class BillingInfo :  IEquatable<BillingInfo>, IValidatableObject
    {
        ...
        public BillingInfo(BillingInfoAllOfBillingInfo billingInfo = default(BillingInfoAllOfBillingInfo))
        {
            this._BillingInfo = billingInfo;
        }

        /// <summary>
        /// Gets or Sets _BillingInfo
        /// </summary>
        [DataMember(Name="billing_info", EmitDefaultValue=false)]
        public BillingInfoAllOfBillingInfo _BillingInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _BillingInfo: ").Append(_BillingInfo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(BillingInfo input)
        {
            ...
            return 
                (
                    this._BillingInfo == input._BillingInfo ||
                    (this._BillingInfo != null &&
                    this._BillingInfo.Equals(input._BillingInfo))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._BillingInfo != null)
                    hashCode = hashCode * 59 + this._BillingInfo.GetHashCode();
                return hashCode;
            }
        }
