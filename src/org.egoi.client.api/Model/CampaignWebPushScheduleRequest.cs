...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignWebPushScheduleRequest :  IEquatable<CampaignWebPushScheduleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignWebPushScheduleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignWebPushScheduleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignWebPushScheduleRequest" /> class.
        /// </summary>
        ...
        public CampaignWebPushScheduleRequest(DateTime scheduleDate = default(DateTime), int siteId = default(int), OSegmentsWithoutContactActionSend segments = default(OSegmentsWithoutContactActionSend), List<int> notify = default(List<int>))
        {
            // to ensure "siteId" is required (not null)
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for CampaignWebPushScheduleRequest and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for CampaignWebPushScheduleRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CampaignWebPushScheduleRequest);
        }

        /// <summary>
        /// Returns true if CampaignWebPushScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignWebPushScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignWebPushScheduleRequest input)
        {
            if (input == null)
                return false;
