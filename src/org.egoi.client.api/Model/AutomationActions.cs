...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutomationActions :  IEquatable<AutomationActions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationActions" /> class.
        /// </summary>
        /// <param name="title">Action title.</param>
        /// <param name="action">Type od action.</param>
        public AutomationActions(string title = default(string), string action = default(string))
        {
            this.Title = title;
            this.Action = action;
        }
        ...
        {
            return this.Equals(input as AutomationActions);
        }

        /// <summary>
        /// Returns true if AutomationActions instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationActions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationActions input)
        {
            if (input == null)
                return false;
