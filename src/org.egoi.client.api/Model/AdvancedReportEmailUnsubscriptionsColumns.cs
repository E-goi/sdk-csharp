...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportEmailUnsubscriptionsColumns :  IEquatable<AdvancedReportEmailUnsubscriptionsColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailUnsubscriptionsColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportEmailUnsubscriptionsColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportEmailUnsubscriptionsColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportEmailUnsubscriptionsColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), EmailUnsubscriptionsListStatsFields listStatsFields = default(EmailUnsubscriptionsListStatsFields), EmailUnsubscriptionsCampaignFields campaignFields = default(EmailUnsubscriptionsCampaignFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportEmailUnsubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportEmailUnsubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportEmailUnsubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignFields is a required property for AdvancedReportEmailUnsubscriptionsColumns and cannot be null");
            }
            else
            {
        ...
        public EmailUnsubscriptionsListStatsFields ListStatsFields { get; set; }

        /// <summary>
        /// Gets or Sets CampaignFields
        /// </summary>
        [DataMember(Name="campaign_fields", EmitDefaultValue=true)]
        public EmailUnsubscriptionsCampaignFields CampaignFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportEmailUnsubscriptionsColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportEmailUnsubscriptionsColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportEmailUnsubscriptionsColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportEmailUnsubscriptionsColumns input)
        {
            if (input == null)
                return false;
