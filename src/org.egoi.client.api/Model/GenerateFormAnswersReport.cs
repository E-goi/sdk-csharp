...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateFormAnswersReport :  IEquatable<GenerateFormAnswersReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateFormAnswersReport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateFormAnswersReport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateFormAnswersReport" /> class.
        /// </summary>
        ...
        /// Gets or Sets Forms
        /// </summary>
        [DataMember(Name="forms", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as GenerateFormAnswersReport);
        }

        /// <summary>
        /// Returns true if GenerateFormAnswersReport instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateFormAnswersReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateFormAnswersReport input)
        {
            if (input == null)
                return false;
