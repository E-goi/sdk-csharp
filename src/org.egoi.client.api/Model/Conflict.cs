...
namespace org.egoi.client.api.Model
{
    ...
    public partial class Conflict :  IEquatable<Conflict>, IValidatableObject
    {
        ...
        public Conflict(Object errors = default(Object), string type = default(string), TitleEnum? title = default(TitleEnum?), int status = default(int), string detail = default(string))
        {
            this.Errors = errors;
            this.Type = type;
            this.Title = title;
