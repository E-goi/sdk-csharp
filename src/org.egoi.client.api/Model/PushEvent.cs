...
namespace org.egoi.client.api.Model
{
    ...
    public partial class PushEvent :  IEquatable<PushEvent>, IValidatableObject
    {
        ...
        /// <param name="mailingId">The id of the campaign operation related to the notification..</param>
        ...
        public PushEvent(string os = default(string), string contact = default(string), string messageHash = default(string), int mailingId = default(int), string _event = default(string), int deviceId = default(int))
        {
        ...
        /// </summary>
        /// <value>The id of the campaign operation related to the notification.</value>
        [DataMember(Name="mailing_id", EmitDefaultValue=false)]
