...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedReportSubscriptionsColumns :  IEquatable<AdvancedReportSubscriptionsColumns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSubscriptionsColumns" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedReportSubscriptionsColumns() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedReportSubscriptionsColumns" /> class.
        /// </summary>
        ...
        public AdvancedReportSubscriptionsColumns(List<string> listBaseFields = default(List<string>), List<Object> listExtraFields = default(List<Object>), SubscriptionsListStatsFields listStatsFields = default(SubscriptionsListStatsFields))
        {
            // to ensure "listBaseFields" is required (not null)
            if (listBaseFields == null)
            {
                throw new InvalidDataException("listBaseFields is a required property for AdvancedReportSubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listExtraFields is a required property for AdvancedReportSubscriptionsColumns and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("listStatsFields is a required property for AdvancedReportSubscriptionsColumns and cannot be null");
            }
            else
            {
        ...
        public SubscriptionsListStatsFields ListStatsFields { get; set; }
        ...
        {
            return this.Equals(input as AdvancedReportSubscriptionsColumns);
        }

        /// <summary>
        /// Returns true if AdvancedReportSubscriptionsColumns instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedReportSubscriptionsColumns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedReportSubscriptionsColumns input)
        {
            if (input == null)
                return false;
