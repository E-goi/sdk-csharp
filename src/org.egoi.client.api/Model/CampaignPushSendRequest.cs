...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignPushSendRequest :  IEquatable<CampaignPushSendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPushSendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignPushSendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPushSendRequest" /> class.
        /// </summary>
        ...
        public CampaignPushSendRequest(string appId = default(string), OSegmentsWithoutContactActionSend segments = default(OSegmentsWithoutContactActionSend), List<int> notify = default(List<int>), DateTime scheduleDate = default(DateTime))
        {
            // to ensure "appId" is required (not null)
            if (appId == null)
            {
                throw new InvalidDataException("appId is a required property for CampaignPushSendRequest and cannot be null");
            }
            else
            {
                this.AppId = appId;
            ...
            if (segments == null)
            {
                throw new InvalidDataException("segments is a required property for CampaignPushSendRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignPushSendRequest {\n");
        ...
        {
            return this.Equals(input as CampaignPushSendRequest);
        }

        /// <summary>
        /// Returns true if CampaignPushSendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignPushSendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignPushSendRequest input)
        {
            if (input == null)
                return false;
