...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderProduct :  IEquatable<OrderProduct>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="quantity">Quantity of the product (default to 0D).</param>
        ...
        public OrderProduct(string productIdentifier = default(string), string name = default(string), string description = default(string), string sku = default(string), string upc = default(string), string ean = default(string), string gtin = default(string), string mpn = default(string), string link = default(string), string imageLink = default(string), double price = 0D, double salePrice = 0D, string brand = default(string), double quantity = 0D, List<string> categories = default(List<string>), List<string> relatedProducts = default(List<string>), List<ProductCustomAttributes> customAttributes = default(List<ProductCustomAttributes>))
        {
        ...
        {
            return this.Equals(input as OrderProduct);
        }

        /// <summary>
        /// Returns true if OrderProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderProduct input)
        {
            if (input == null)
                return false;
