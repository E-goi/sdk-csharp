...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactBaseStatusExtraBulk :  IEquatable<ContactBaseStatusExtraBulk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactBaseStatusExtraBulk" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContactBaseStatusExtraBulk);
        }

        /// <summary>
        /// Returns true if ContactBaseStatusExtraBulk instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactBaseStatusExtraBulk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactBaseStatusExtraBulk input)
        {
            if (input == null)
                return false;
