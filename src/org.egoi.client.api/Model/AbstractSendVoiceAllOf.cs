...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AbstractSendVoiceAllOf :  IEquatable<AbstractSendVoiceAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractSendVoiceAllOf" /> class.
        /// </summary>
        /// <param name="destinationField">Destination field of this campaign.</param>
        public AbstractSendVoiceAllOf(DestinationFieldEnum? destinationField = default(DestinationFieldEnum?))
        {
        ...
        {
            return this.Equals(input as AbstractSendVoiceAllOf);
        }

        /// <summary>
        /// Returns true if AbstractSendVoiceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractSendVoiceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractSendVoiceAllOf input)
        {
            if (input == null)
                return false;
