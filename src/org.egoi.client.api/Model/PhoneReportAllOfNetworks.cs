...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhoneReportAllOfNetworks :  IEquatable<PhoneReportAllOfNetworks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneReportAllOfNetworks" /> class.
        /// </summary>
        ...
        public PhoneReportAllOfNetworks(string network = default(string), int sends = default(int), int delivered = default(int), int error = default(int), int invalid = default(int), int pending = default(int))
        {
        ...
        {
            return this.Equals(input as PhoneReportAllOfNetworks);
        }

        /// <summary>
        /// Returns true if PhoneReportAllOfNetworks instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneReportAllOfNetworks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneReportAllOfNetworks input)
        {
            if (input == null)
                return false;
