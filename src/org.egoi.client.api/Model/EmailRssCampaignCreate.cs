...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailRssCampaignCreate :  IEquatable<EmailRssCampaignCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailRssCampaignCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailRssCampaignCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailRssCampaignCreate" /> class.
        /// </summary>
        ...
        public EmailRssCampaignCreate(int listId = default(int), string internalName = default(string), string subject = default(string), CampaignEmailRssContent content = default(CampaignEmailRssContent), int senderId = default(int), int replyTo = default(int), HeaderFooter headerFooter = default(HeaderFooter))
        {
            // to ensure "listId" is required (not null)
            if (listId == null)
            {
                throw new InvalidDataException("listId is a required property for EmailRssCampaignCreate and cannot be null");
            }
            else
            {
                this.ListId = listId;
            ...
            {
                throw new InvalidDataException("internalName is a required property for EmailRssCampaignCreate and cannot be null");
            }
            else
            {
            ...
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for EmailRssCampaignCreate and cannot be null");
            }
            else
            {
            ...
            if (senderId == null)
            {
                throw new InvalidDataException("senderId is a required property for EmailRssCampaignCreate and cannot be null");
            }
            else
            {
        ...
        public CampaignEmailRssContent Content { get; set; }
        ...
        {
            return this.Equals(input as EmailRssCampaignCreate);
        }

        /// <summary>
        /// Returns true if EmailRssCampaignCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailRssCampaignCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailRssCampaignCreate input)
        {
            if (input == null)
                return false;
