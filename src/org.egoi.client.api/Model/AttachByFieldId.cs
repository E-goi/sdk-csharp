...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttachByFieldId :  IEquatable<AttachByFieldId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachByFieldId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttachByFieldId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachByFieldId" /> class.
        /// </summary>
        /// <param name="fieldId">fieldId (required).</param>
        /// <param name="contacts">Array of contacts to attach the tag (required).</param>
        public AttachByFieldId(string fieldId = default(string), List<string> contacts = default(List<string>))
        {
            // to ensure "fieldId" is required (not null)
            if (fieldId == null)
            {
                throw new InvalidDataException("fieldId is a required property for AttachByFieldId and cannot be null");
            }
            else
            {
            ...
            if (contacts == null)
            {
                throw new InvalidDataException("contacts is a required property for AttachByFieldId and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AttachByFieldId);
        }

        /// <summary>
        /// Returns true if AttachByFieldId instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachByFieldId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachByFieldId input)
        {
            if (input == null)
                return false;
