...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailContentHtmlPatch :  IEquatable<CampaignEmailContentHtmlPatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailContentHtmlPatch" /> class.
        /// </summary>
        /// <param name="body">HTML code of the campaign.</param>
        /// <param name="plainText">Plain text for the campaign.</param>
        /// <param name="snippet">Snippet text for the campaign.</param>
        public CampaignEmailContentHtmlPatch(string body = default(string), string plainText = default(string), string snippet = default(string))
        {
            this.Body = body;
        ...
        {
            return this.Equals(input as CampaignEmailContentHtmlPatch);
        }

        /// <summary>
        /// Returns true if CampaignEmailContentHtmlPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailContentHtmlPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailContentHtmlPatch input)
        {
            if (input == null)
                return false;
