...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GenerateSendsReport :  IEquatable<GenerateSendsReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateSendsReport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateSendsReport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateSendsReport" /> class.
        /// </summary>
        ...
        public GenerateSendsReport(string title = default(string), AdvancedReportRange range = default(AdvancedReportRange), List<int> lists = default(List<int>), AdvancedReportSendsColumns columns = default(AdvancedReportSendsColumns), AdvancedReportSendsOptions options = default(AdvancedReportSendsOptions), string callbackUrl = default(string))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for GenerateSendsReport and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (range == null)
            {
                throw new InvalidDataException("range is a required property for GenerateSendsReport and cannot be null");
            }
            else
            {
                this.Range = range;
            ...
            if (lists == null)
            {
                throw new InvalidDataException("lists is a required property for GenerateSendsReport and cannot be null");
            }
            else
            {
                this.Lists = lists;
            ...
            if (columns == null)
            {
                throw new InvalidDataException("columns is a required property for GenerateSendsReport and cannot be null");
            }
            else
            {
            ...
            if (options == null)
            {
                throw new InvalidDataException("options is a required property for GenerateSendsReport and cannot be null");
            }
            else
            {
        ...
        public AdvancedReportSendsColumns Columns { get; set; }

        /// <summary>
        /// Gets or Sets Options
        /// </summary>
        [DataMember(Name="options", EmitDefaultValue=true)]
        public AdvancedReportSendsOptions Options { get; set; }
        ...
        {
            return this.Equals(input as GenerateSendsReport);
        }

        /// <summary>
        /// Returns true if GenerateSendsReport instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateSendsReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateSendsReport input)
        {
            if (input == null)
                return false;
