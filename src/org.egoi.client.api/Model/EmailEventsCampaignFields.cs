...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailEventsCampaignFields :  IEquatable<EmailEventsCampaignFields>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailEventsCampaignFields" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailEventsCampaignFields() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailEventsCampaignFields" /> class.
        /// </summary>
        ...
        /// <param name="url">True to include the URL of the campaign, false otherwise.</param>
        ...
        public EmailEventsCampaignFields(bool internalName = default(bool), bool campaignHash = default(bool), bool sendDate = default(bool), bool group = default(bool), bool channel = default(bool), bool type = default(bool), bool url = default(bool), bool sender = default(bool), bool city = default(bool), bool country = default(bool), bool region = default(bool), bool program = default(bool), bool os = default(bool))
        {
            // to ensure "internalName" is required (not null)
            if (internalName == null)
            {
                throw new InvalidDataException("internalName is a required property for EmailEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("campaignHash is a required property for EmailEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            if (sendDate == null)
            {
                throw new InvalidDataException("sendDate is a required property for EmailEventsCampaignFields and cannot be null");
            }
            else
            {
            ...
            if (group == null)
            {
                throw new InvalidDataException("group is a required property for EmailEventsCampaignFields and cannot be null");
            }
            else
            {
                this.Group = group;
        ...
        [DataMember(Name="send_date", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as EmailEventsCampaignFields);
        }

        /// <summary>
        /// Returns true if EmailEventsCampaignFields instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailEventsCampaignFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailEventsCampaignFields input)
        {
            if (input == null)
                return false;
