...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsCampaignTemplate : PhoneCampaignTemplate,  IEquatable<SmsCampaignTemplate>, IValidatableObject
    {
        /// <summary>
        /// Message encoding
        /// </summary>
        ...
        public SmsCampaignTemplate(EncodingEnum? encoding = default(EncodingEnum?), int? maxMessages = default(int?), string internalName = default(string), string message = default(string), string sender = default(string), MessageTypeEnum? messageType = default(MessageTypeEnum?)) : base(message, sender, messageType)
        {
