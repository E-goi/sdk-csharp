...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignSmartSmsImport :  IEquatable<CampaignSmartSmsImport>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmartSmsImport" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignSmartSmsImport() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignSmartSmsImport" /> class.
        /// </summary>
        ...
        public CampaignSmartSmsImport(TypeEnum type = default(TypeEnum), string pageUrl = default(string), string pageInternalName = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CampaignSmartSmsImport and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (pageUrl == null)
            {
                throw new InvalidDataException("pageUrl is a required property for CampaignSmartSmsImport and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CampaignSmartSmsImport);
        }

        /// <summary>
        /// Returns true if CampaignSmartSmsImport instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignSmartSmsImport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignSmartSmsImport input)
        {
            if (input == null)
                return false;
