...
{
    /// <summary>
    /// EmailReportByLocationLocation
    /// </summary>
    [DataContract]
    public partial class EmailReportByLocationLocation :  IEquatable<EmailReportByLocationLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailReportByLocationLocation" /> class.
        /// </summary>
        ...
        public EmailReportByLocationLocation(string location = default(string), string region = default(string), string country = default(string), int opens = default(int), int clicks = default(int), int hardBounces = default(int), int softBounces = default(int), int complaints = default(int), int unsubscriptions = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailReportByLocationLocation {\n");
        ...
        {
            return this.Equals(input as EmailReportByLocationLocation);
        }

        /// <summary>
        /// Returns true if EmailReportByLocationLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailReportByLocationLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailReportByLocationLocation input)
        {
            if (input == null)
                return false;
