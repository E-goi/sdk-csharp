...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HashcodeCampaign :  IEquatable<HashcodeCampaign>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HashcodeCampaign" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as HashcodeCampaign);
        }

        /// <summary>
        /// Returns true if HashcodeCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of HashcodeCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HashcodeCampaign input)
        {
            if (input == null)
                return false;
