...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignEmailContentWebPage :  IEquatable<CampaignEmailContentWebPage>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Webpage for value: web_page
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailContentWebPage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignEmailContentWebPage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignEmailContentWebPage" /> class.
        /// </summary>
        ...
        public CampaignEmailContentWebPage(TypeEnum type = default(TypeEnum), string url = default(string), bool usePageTitle = false, string plainText = default(string), string snippet = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CampaignEmailContentWebPage and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for CampaignEmailContentWebPage and cannot be null");
            }
            else
            {
                this.Url = url;
        ...
        {
            return this.Equals(input as CampaignEmailContentWebPage);
        }

        /// <summary>
        /// Returns true if CampaignEmailContentWebPage instances are equal
        /// </summary>
        /// <param name="input">Instance of CampaignEmailContentWebPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CampaignEmailContentWebPage input)
        {
            if (input == null)
                return false;
