...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Product : BasicProduct,  IEquatable<Product>, IValidatableObject
    {
        /// <summary>
        ...
        public Product(List<string> categories = default(List<string>), List<string> relatedProducts = default(List<string>), string productIdentifier = default(string), string name = default(string), string description = default(string), string sku = default(string), string upc = default(string), string ean = default(string), string gtin = default(string), string mpn = default(string), string link = default(string), string imageLink = default(string), double? price = default(double?), double? salePrice = default(double?), string brand = default(string)) : base(productIdentifier, catalogId, name, description, sku, upc, ean, gtin, mpn, link, imageLink, price, salePrice, brand)
        {
