...
namespace org.egoi.client.api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactUtmPost :  IEquatable<ContactUtmPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactUtmPost" /> class.
        /// </summary>
        ...
        public ContactUtmPost(string utmSource = default(string), string utmMedium = default(string), string utmCampaign = default(string), string utmContent = default(string), string utmTerm = default(string))
        {
        ...
        {
            return this.Equals(input as ContactUtmPost);
        }

        /// <summary>
        /// Returns true if ContactUtmPost instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactUtmPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactUtmPost input)
        {
            if (input == null)
                return false;
