...
namespace org.egoi.client.api.Test
{
    ...
    public class ContactsApiTests
    {
        ...
        public void ActionImportBulkTest()
        {
            ...
            //var response = instance.ActionImportBulk(listId, importBulkFileRequest);
            //Assert.IsInstanceOf(typeof(AcceptedResponse), response, "response is AcceptedResponse");
        }
        ...
        public void GetAllContactActivitiesTest()
        {
            ...
            //var response = instance.GetAllContactActivities(contactId, listId, offset, limit, dateMin, dateMax, actionName);
        ...
        /// <summary>
        /// Test UpdateContactByField
        /// </summary>
        [Test]
        public void UpdateContactByFieldTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int listId = null;
            //ContactFieldIdBaseExtraPost contactFieldIdBaseExtraPost = null;
            //var response = instance.UpdateContactByField(listId, contactFieldIdBaseExtraPost);
            //Assert.IsInstanceOf(typeof(CreateContactResponse), response, "response is CreateContactResponse");
        }
