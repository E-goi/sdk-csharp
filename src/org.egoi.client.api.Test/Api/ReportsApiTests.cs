...
namespace org.egoi.client.api.Test
{
    ...
    public class ReportsApiTests
    {
        ...
        /// </summary>
        [Test]
        public void GetPushReportTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string campaignHash = null;
            //bool? operatingSystems = null;
            //var response = instance.GetPushReport(campaignHash, operatingSystems);
            //Assert.IsInstanceOf(typeof(PushReport), response, "response is PushReport");
        }
