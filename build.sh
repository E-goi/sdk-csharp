...
${nuget_cmd} install src/org.egoi.client.api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/org.egoi.client.api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/org.egoi.client.api.dll \
-recurse:'src/org.egoi.client.api/*.cs' \
-doc:bin/org.egoi.client.api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/org.egoi.client.api.dll was created successfully"
fi
